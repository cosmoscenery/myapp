					...
					<div id="s2_inner">
						<div class="join">
							<form name="inputform" action="joinAction.do" method="post"
								...
								<!-- 2-1. 중복확인 버튼 안눌렀을 때 0으로 설정/ 누르면 1로 설정 -->
								<input type="hidden" name="hiddenUserid" value="0">  <!-- 중복확인 버튼을 눌렀는지 확인용/ 안누르면 0  -->
								<table>
									<tr>
										<th> * 아이디 </th>
										<td>
									...
									<tr>
								 	...
								 	<tr>
										...
										<td>
											...
											@
											<input type="text" class="input" name="user_email2" size="4" style="width:100px" required>
											<select class="input" name="user_email3" style="width:100px" onchange="selectEmailChk()">
												<option value=""> 직접입력 </option>
												<option value="naver.com"> 네이버 </option>
												<option value="googe.com"> 구글 </option>
								 	...
								 	<tr>
								 		...
								 		<br>
								 		<div align="right">
								 			<input class="inputBotton" type="submit" value="회원가입">
								 			<input class="inputBotton" type="reset" value="초기화">
								 			<input class="inputBotton" type="button" value="가입취소" onclick="window.location='main.do'">
								 		</div>
								 	</tr>
