									...
									<table>
										<tr>
									 	...
									 	<tr>
									 		...
									 		<br>
									 		<div align="right">
									 			<input class="inputBotton" type="button" value="회원수정" onclick="window.location='${path}/modifyCustomer.do'">	
									 			<input class="inputBotton" type="button" value="회원탈퇴" onclick="window.location='${path}/deleteCustomer.do'">
									 			<input class="inputBotton" type="button" value="로그아웃" onclick="window.location='${path}/logout.do'">
									 		
									 			&nbsp;&nbsp;&nbsp;  <!-- 공백 -->
									 			<!-- admin/1234 가입 후 admin으로 로그인 할 때만 관리자 링크 보이게하기 -->
