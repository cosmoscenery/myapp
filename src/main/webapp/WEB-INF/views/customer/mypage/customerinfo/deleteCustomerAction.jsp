...
<body>
	<div class="wrap">
		...
		<!-- 컨텐츠 시작 -->
		<%
		int deleteCnt = (Integer)request.getAttribute("deleteCnt");  //request.getAttribute("insertCnt")가 오브젝트 타입이기 때문에 (Integer)로 형 변환
		int selectCnt = (Integer)request.getAttribute("selectCnt");  //request.getAttribute("insertCnt")가 오브젝트 타입이기 때문에 (Integer)로 형 변환
		%>
